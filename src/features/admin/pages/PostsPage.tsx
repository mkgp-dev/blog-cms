...
import PostDialog from "@/features/admin/components/PostDialog";
import { PostViewDialog } from "@/features/admin/components/PostViewDialog";
...
export default function PostsPage() {
    ...
    const [deletePostState, setDeletePostState] = useState<AdminPost | null>(null);
    ...
    const { data, isLoading, error } = useQuery({
        queryKey: adminQueryKeys.posts(searchParams),
        queryFn: () => fetchAdminPosts(searchParams),
    });
    ...
    const createMutation = useMutation({
        ...
        onSuccess: async () => {
            await queryClient.invalidateQueries({ queryKey: adminQueryKeys.postsList });
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Manage your posts efficiently by creating, editing, publishing, and
                        organizing content in one place.
                    </p>
                </div>
            ...
            <ConfirmDialog
                ...
                onConfirm={() => {
                    if (deletePostState) {
                        deleteMutation.mutate(deletePostState.id);
                    }
                }}
