...
function createInitialFormState(initialValues?: AdminPost | null): FormState {
    return {
...
function PostDialogForm({
    ...
    const [form, setForm] = useState<FormState>(() => createInitialFormState(initialValues));
...
export default function PostDialog({
    ...
    const formKey = `${mode}-${initialValues?.id ?? "new"}`;
